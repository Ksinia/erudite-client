export const TRANSLATIONS: { [key: string]: { [key: string]: string } } = {
  en_US: {
    ...
    board_out_of_date:
      'The board changed while you were making your move. Check it before confirming.',
    retry: 'Try again',
    ...
    board_infinite_option: 'Infinite board',
  ...
  ru_RU: {
    ...
    board_out_of_date:
      'Поле изменилось, пока вы делали ход. Проверьте его перед подтверждением.',
    retry: 'Повторить',
    ...
    board_type: 'Поле: ',
    board_classic: 'классическое',
    board_infinite: 'бесконечное',
    board_infinite_option: 'Бесконечное поле',
